...
| `getToggleButtonProps` | `<button>` | Call and destructure its returned object on the toggle button.                      |
...
selected_. _item.title_ is chosen to be the string equialent of each item
object.
      ...
      <div onMouseLeave={closeMenu}>
        <div className="w-72 flex flex-col gap-1">
          ...
          <div className="flex justify-between">
            <button
              aria-label="toggle menu"
              className="p-2 bg-white flex justify-between grow"
              type="button"
              {...getToggleButtonProps({
                onMouseEnter() {
                  openMenu()
