...
_useSelect_ has been affected by breaking changes in v8 and v9, so check out the
migration pages for [v8][migration-guide-v8] and [v9][migration-guide-v9].
    ...
    return (
      <div>
        <div className="w-72 flex flex-col gap-1">
          ...
          <div
            className="p-2 bg-white dark:bg-zinc-900 flex justify-between cursor-pointer"
            {...getToggleButtonProps()}
          >
    ...
    return (
      <Box>
        ...
        <List
          className={cx(
            !isOpen && 'hidden',
            '!absolute bg-white dark:bg-zinc-900 w-72 shadow-md max-h-80 overflow-scroll',
          )}
          {...getMenuProps()}
        >
          {isOpen &&
              ...
              return (
                <ListItem
                  className={cx(
                    ...
                    selectedItem === item &&
                      'font-bold !text-black dark:!text-white',
                    'py-2 px-3 shadow-sm text-zinc-900 dark:text-zinc-100',
                  )}
                  key={item.id}
                  {...getItemProps({
                    item,
              ...
              <li
                className={cx(
                  ...
                  selectedItems.includes(item) &&
                    'font-bold !text-black dark:!text-white',
                  'py-2 px-3 shadow-sm flex gap-3 items-center text-zinc-900 dark:text-zinc-100',
                )}
                key={item.id}
                {...getItemProps({
                  item,
...
example][code-sandbox-select-tag-group].
      ...
      <div onMouseLeave={closeMenu}>
        <div className="w-72 flex flex-col gap-1">
          ...
          <div className="flex justify-between">
            <div
              className="p-2 bg-white dark:bg-zinc-900 flex justify-between grow cursor-pointer"
              {...getToggleButtonProps({
                onMouseEnter() {
                  openMenu()
                },
            ...
            <button
              ...
              className="p-2 bg-white dark:bg-zinc-900"
              type="button"
              onClick={() => {
                selectItem(null)
              }}
                ...
                <li
                  className={cx(
                    highlightedIndex === virtualRow.index &&
                      'bg-blue-300 !text-black dark:bg-sky-700 dark:!text-white',
                    selectedItem === books[virtualRow.index] &&
                      'font-bold !text-black dark:!text-white',
                    'py-2 px-3 shadow-sm flex flex-col text-zinc-900 dark:text-zinc-100',
                  )}
