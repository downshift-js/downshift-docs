...
The component can be used with _React Native_ as well. The HTML elements and styles
are replaced with React Native equivalents, but the _Downshift_ usage is exactly
